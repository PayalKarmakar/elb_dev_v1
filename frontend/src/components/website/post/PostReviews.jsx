      ...
      <div className="review-card bg-white mb-4">
        ...
        {/* <div className="custom-dropdown dropdown">
          <button
            ...
            type="button"
            data-bs-dropdown="dropdown"
            aria-expanded="true"
          >
            Select
          </button>
          <ul class="custom-dropdown-menu dropdown-menu" style="">
            <li class="dropdown-item">
              Site Templates <span>(12)</span>
            </li>
            <li class="dropdown-item">
              Wordpress <span>(12)</span>
            </li>
            <li class="dropdown-item">
              Template Kits <span>(55)</span>
            </li>
            <li class="dropdown-item">
              E-commerce <span>(20)</span>
            </li>
            <li class="dropdown-item">
              Blogging <span>(12)</span>
            </li>
            <li class="dropdown-item">
              UI Templates <span>(50)</span>
            </li>
          </ul>
        </div> */}

        <div class="px-4 pb-4 msg-write-input d-flex flex-column flex-md-row align-items-center gap-3">
          <input
            type="text"
            class="form-control rounded-5 bg-offWhite shadow-none"
        ...
        <div class="review-card bg-white">
          <div>
            <div class="d-flex justify-content-between mb-3">
              ...
              <span class="text-dark-200 fs-6">2 days ago</span>
            </div>
            ...
            <div class="d-flex align-items-center buyer-info pb-30 justify-content-between mt-4">
              <div class="d-flex align-items-center gap-3">
                <div>
                  <img src={av} class="rounded-circle" alt="Image" />
                </div>
                <div>
                  <h4 class="text-18 text-dark-300 fw-semibold">
                    Abubokkor Siddik
                  </h4>
                  <p class="text-dark-200 fs-6">United Kingdom</p>
                </div>
              </div>
              <div>
          ...
          <div class="seller-reply ps-5 d-flex align-items-center gap-3 pt-30">
            <img src={av2} class="rounded-circle" alt="Image" />
            <p class="text-dark-200 fs-6">
        ...
        <div class="review-card bg-white">
          <div>
            ...
            <div class="d-flex align-items-center buyer-info justify-content-between mt-4">
              <div class="d-flex align-items-center gap-3">
                <div>
                  <img src={av} class="rounded-circle" alt="" />
                </div>
                <div>
                  <h4 class="text-18 text-dark-300 fw-semibold">Samuel Jhon</h4>
                  <p class="text-dark-200 fs-6">Tunisia</p>
                </div>
              </div>
              <div>
                <button class="reply-btn">Reply</button>
