                          ...
                          <div className="row g-4">
                            <div className="col-md-6">
                              <div className="form-container">
                                <label for="fname" className="form-label">First Name
                            ...
                            <div className="col-md-6">
                              <div className="form-container">
                                <label for="lname" className="form-label" >Last Name
                                  <span className="text-lime-300">*</span></label>
                                <input
                                  type="text"
                                  className="form-control shadow-none"
                                  placeholder="Musa"
                            ...
                            <div className="col-12">
                              <label for="description" className="form-label">Description
                                <span className="text-lime-300">*</span></label>
                        ...
                        <div className="profile-info-body bg-white">
                          <div className="row g-4">
                            <div className="col-12">
                              ...
                              <div
                                className="skill-cloud mt-4 d-flex align-items-center gap-3 flex-wrap"
                              >
